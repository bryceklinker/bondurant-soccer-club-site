...
function renderMenuItem(
    ...
    return (
        <Link
            ...
            <DefaultButton className={'nav-button'}>{item.text}</DefaultButton>
        </Link>
    );
}
...
export const MoreNavbar: FunctionComponent<MoreInfoLinksProps> = ({
    onClick
}) => {
    ...
    return (
        <CommandButton
            className={'nav-button command-button'}
            aria-label={'more nav button'}
            text={'More Info'}
            menuProps={menuProps}
        />
    );

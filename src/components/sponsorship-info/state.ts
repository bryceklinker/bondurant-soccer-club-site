...
export const SPONSOR_LINKS: Array<LinkData> = [
    ...
    {
        text: 'City of Bondurant',
        url: 'https://www.cityofbondurant.com/'
    },
    {
        text: 'Capital City Equipment',
        url: 'https://www.capitalcityequipmentcompany.com/'
    },
    {

import {ByLawArticleData, ByLawsData} from './models';
...
const ARTICLE_2: ByLawArticleData = {
    key: 'II',
    title: 'Purpose',
    text: 'The purpose for which this Corporation is formed is to further and promote the progressive ' +
...
const ARTICLE_3: ByLawArticleData = {
    ...
    sections: [
        ...
        },
        {
            ...
            description: 'Level 3 teams within the club shall be formed by the following criteria and abiding by all league guidelines',
            items: [
                'Age',
                'Gender'
            ]
...
const ARTICLE_4: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Annual Meeting An annual meeting of the members of BSC shall be held in the last quarter of ' +
                'the fiscal year for the purpose of electing and installing Officers and for such other business as may be ' +
                'appropriate.'
        },
        {
            key: '2',
            title: 'Quorum The members present will constitute a quorum for the transaction of business at the ' +
                'annual meeting of the members of BSC.'
        },
        {
            key: '3',
            title: 'Elections and Voting Any member can make a nomination for election of an officer to the ' +
        ...
        {
            key: '4',
            title: 'Participation in Meeting Any member of BSC shall have the right to attend meetings of BSC, ' +
...
const ARTICLE_5: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Board Members The affairs of BSC shall be governed by a Board of Directors as elected by the ' +
        ...
        {
            key: '2',
            title: 'Election of Board The President, Vice President, Secretary, and Treasurer shall be elected by ' +
        ...
        {
            key: '3',
            title: 'Terms of Office The elected Board of Directors of BSC will serve a term of two (2) years. A ' +
        ...
        {
            key: '6',
            title: 'Regular Meetings The Board of Directors of BSC shall hold monthly meetings on the last ' +
        ...
        {
            key: '7',
            title: 'Quorum At any meeting of the Board of Directors a quorum for the transaction of business ' +
                'shall be simple majority of the Directors present.',
        },
        {
            key: '8',
            title: 'Compensation All members of the Board of Directors shall serve without compensation ' +
                'except that actual expenses authorized by the Board of Directors may be reimbursed.',
        },
        {
            key: '9',
            title: 'Membership on the Board and Special Areas of Responsibilities The President, Vice ' +
        ...
        {
            key:'10',
            title: 'Director on Duty. In addition to the aforementioned duties, all Directors and Assistant ' +
                'Directors are responsible to be the Director on Duty for a minimum of one soccer day per season. '
        },
        {
            key: '11',
            title: 'Park and Recreation Board Member – In addition, one Board member must attend the City ' +
                'of Bondurant Park and Recreation monthly meeting. This Board member must be a resident of the City ' +
                'of Bondurant.'
        },
        {
            key: '12',
            title: 'Terms of Office – The appointed Board of Directors of BSC will serve a term of one year. A ' +
...
const ARTICLE_6: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Officers The Officers of BSC, elected by the members, as provided in Article IV, Section 3, shall ' +
        ...
        {
            key: '2',
            title: 'President The President shall call and preside at all meetings of the Board of Directors and ' +
        ...
        {
            key: '3',
            title: 'Vice President In the event the President shall be absent from any meeting at which he/she is ' +
        ...
        {
            key: '4',
            title: 'Secretary The Secretary shall record and maintain the minutes of all meetings and provide ' +
        ...
        {
            key: '5',
            title: 'Treasurer The Treasurer shall keep the financial records of BSC and shall make such reports ' +
        ...
        {
            key: '6',
            title: 'Compensation All Officers of BSC shall serve without compensation except that actual' +
...
const ARTICLE_7: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Executive Committee There shall be an Executive Committee that shall consist of the ' +
        ...
        {
            key: '2',
            title: 'Nominating Committee The Nominating Committee shall consist of the two elected officers ' +
        ...
        {
            key: '3',
            title: ' Internal Audit Committee The Vice President shall appoint, as early in each fiscal year as ' +
        ...
        {
            key: '4',
            title: 'Special Committees and Coordinators Special Committees and Coordinators may be ' +
...
const ARTICLE_9: ByLawArticleData = {
    ...
    text: 'Robert’s Rules of Order, Revised, shall govern all activities of the Corporation except as limited by the ' +
...
const ARTICLE_10: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Checks and Debt Instruments All checks, promissory notes, bonds, debentures, and such ' +
        ...
        {
            key: '2',
            title: 'Contracts, Deeds, and Leases All contracts (excluding purchase orders and commitments for ' +
...
const ARTICLE_11: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Any person who was or is a party or is threatened to be made a party to any threatened, ' +
        ...
        {
            key: '3',
            title: 'Expenses incurred in defending a civil or criminal action, suit, or proceeding may be paid in ' +
        ...
        {
            key: '4',
            title: 'The indemnification herein provided shall not be deemed exclusive of any other rights to ' +
...
const ARTICLE_12: ByLawArticleData = {
    ...
    sections: [
        {
            key: '1',
            title: 'Nothing to the contrary withstanding, all funds utilized for the purposes of the Corporation ' +
        ...
        {
            key: '2',
            title: 'This Corporation may charge fees and accept personal, corporate, and governmental grants or ' +
...
const ARTICLE_13: ByLawArticleData = {
    key: 'XIII',
    title: 'Nonprofit',
    text: 'This Corporation is not organized for pecuniary profit, and it shall not have any power to issue ' +
...
const ARTICLE_14: ByLawArticleData = {
    ...
    text: 'These Bylaws may be altered, repealed, or amended only by the affirmative vote of two-thirds of the ' +
...
const ARTICLE_15: ByLawArticleData = {
    key: 'XV',
    title: 'Fiscal Year',
    text: 'The fiscal year of this Corporation shall be from the first day of July through the last day of June. ' +
...
const ARTICLE_16: ByLawArticleData = {
    ...
    text: 'The undersigned President of the Bondurant Soccer Club hereby certifies that the foregoing is the\n' +

export const PARENT_CODE_OF_CONDUCT_EXPECTATIONS: Array<string> = [
    ...
    'I will do my best to have my player attend every practice and to participate in everything going on while knowing that all players have different talents and weaknesses, the same as I do. I understand that if my player does not attend at least 50% of the practices they may not play as much in the game as those that show up for the practices.',
    ...
    'I will be mindful to learn the rules of the level of soccer that my child plays at and will learn from the coaches, referees, and soccer board members. If I have questions, they can be directed to the Coach, BSC Director of Referees, or other BSC soccer board member at an appropriate time.'
];

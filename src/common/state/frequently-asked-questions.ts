...
import {
    ...
    PRESIDENTS,
    REGISTRARS, DIRECTORS_OF_U5_U6, DIRECTORS_OF_EQUIPMENT
} from './board-members';
import {FALL_REGISTRATION_DATES, REGISTRATION_SOFTWARE, SPRING_REGISTRATION_DATES} from './registration';
...
export const FREQUENTLY_ASKED_QUESTIONS: Array<FrequentlyAskedQuestionData> = [
    ...
    {
        question: 'Can my player wear earrings, jewelry, hair clips, hard casts?',
    ...
    {
        question: 'What if my player decides not to play or is no longer able to play after I completed registration?',
    ...
    {
        question: 'How do I know if the person with my team is approved to assist?',
    ...
    {
        question: 'What if I don’t agree with what a referee called on the play?',
    ...
    {
        question: 'We have an unruly parent on our team or the team that we played against. Is there anything that can be done?',
...
export const REGISTRATION_FREQUENTLY_ASKED_QUESTIONS: Array<FrequentlyAskedQuestionData> = [
    {
        question: 'Why must I provide a copy of birth certificate or passport? Can I use some other document that shows the player’s date of birth?',
    ...
    {
        question: 'The system doesn\'t allow me to register my player for the age group I think they should be with. Why is that?',
    ...
    {
        question: 'Will my player\'s team be the same as it was last season?',
    ...
    {
        question: 'Can I request my player to be with a specific coach/team/teammate?',
    ...
    {
        question: 'What if my player would like to play for multiple teams?',
    ...
    {
        question: 'I\'m having trouble with registration (I get an error message or my system says I do not have access to view a page). What should I do?',
    ...
    {
        question: 'Registration is closed but my child has now decided that they want to play. What can I do?',
        answer: 'Contact the registrar to determine if there is space available. Be sure to include the ' +
            ...
            `registration is open for the fall each ${Dates.formatShortDate(FALL_REGISTRATION_DATES.earlyBird?.start)}` +
            `through ${Dates.formatShortDate(FALL_REGISTRATION_DATES.cutoff)} and for spring each ` +
            `${Dates.formatShortDate(SPRING_REGISTRATION_DATES.earlyBird?.start)}` +
            `through ${Dates.formatShortDate(SPRING_REGISTRATION_DATES.cutoff)}. Registration cut offs` +
    ...
    {
        question: 'Registration is closed but we just moved to town and my child would like to play. What can I do?',
...
export const COACH_FREQUENTLY_ASKED_QUESTIONS: Array<FrequentlyAskedQuestionData> = [
    {
        question: 'What do I do if it is raining/snowing/freezing/super hot/lightning?',
        ...
        links: [
            {
                ...
                url: `mailto:${BoardMemberData.getMailtoEmails(DIRECTORS_OF_REFEREES.concat(...DIRECTORS_OF_CONCESSIONS))}`
            }
        ]
    },
    {
        ...
        links: [
            ...
            },
            {
                ...
                url: `mailto:${BoardMemberData.getMailtoEmails(DIRECTORS_OF_U5_U6)}`
            }
        ]
    },
    {
        ...
        links: [
            {
                ...
                url: `mailto:${BoardMemberData.getMailtoEmails(DIRECTORS_OF_EQUIPMENT)}`
            }
        ]
    }
];

...
import {BACKGROUND_COLOR_CLASSES, Color, useBackgroundColorClass} from '../../hooks/style-hooks';
...
export const ToggleSwitch: FC<ToggleSwitchProps> = ({onColor, offColor, className, checked, ...props}) => {
    const onBackgroundColor = useBackgroundColorClass(onColor, BACKGROUND_COLOR_CLASSES.primary);
    const offBackgroundColor = useBackgroundColorClass(offColor, BACKGROUND_COLOR_CLASSES.white);

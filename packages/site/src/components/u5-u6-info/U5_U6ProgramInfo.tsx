...
export const U5_U6ProgramInfo: FC = () => {
    return (
        <Section padded shadow>
            <CollapsiblePanel title={<SectionTitle>{AGE_GROUPS.U6.name} Details</SectionTitle>}>
                <U5_U6Locations/>

                <U5_U6Schedule/>

                <U5_U6Section title={'Game Length'}
                              text={'6 - 6-minute quarters (5 minutes breaks between quarters)'} />

                <U5_U6Section title={'Maximum Game Roster'}
                              text={'8'} />

                <U5_U6Section title={'Game Play'}
                              text={'4 v 4'} />

                <U5_U6Section title={'Ball Size'}
                              text={'3'} />

                <U5_U6Section title={'Required Equipment'}
                              text={'Shin Guards'} />

                <U5_U6Section title={'Goalkeeper'}
                              text={'No'} />

                <U5_U6Section title={'Referee'}
                ...
                <U5_U6Section title={'Cancellations'}
    ...
    return (
        <PlainStack>
            <PlainStack horizontal>
                ...
                <Paragraph>
                    U5/U6 program will be all “in-house” meaning there will be no travel. All games will be at
                    the <SmartLink link={COLLISON_SOCCER_PARK_LINK}/>
                </Paragraph>
            </PlainStack>
        </PlainStack>
    );

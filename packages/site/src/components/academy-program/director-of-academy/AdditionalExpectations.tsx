    ...
    return (
        <>
            ...
            <BulletedList>
                ...
                <ListItem>
                    Develop lesson plans for each session based on overall
                    player development. Plans will need to be turned in prior to
                    the season starting. Director must be familiar with the
                    lesson plans if the lesson plans are purchased from an
                    outside source.
                </ListItem>
                <ListItem>
                    Provide training and share lesson plans to the recreation
                    program. Drills need to be shared in a format that is easy
                    to use for the coaches at that level. Roll out plan is as
                    follows: first season - academy u9/u10, 2nd season -
                    academy/rec u9/u10, 3rd season - share with u7/u8, 4th
                    season - share with u11/12.
                </ListItem>
                <ListItem>
                    ...
                    practices a week. 3 sessions a week prior to games starting
                    and then begin to reduce to 2 practices a week.
                </ListItem>
                <ListItem>

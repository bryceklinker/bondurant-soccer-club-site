...
export const VolunteerOpportunityOption: FC<VolunteerOpportunityOptionProps> = ({
    data
}) => {

    const links = useMemo(() => (data.links ?? []).map((l, i) => (
...
const VolunteerOpportunityDescription: FC<VolunteerOpportunityDescriptionProps> = ({data}) => {
    if (!data.description) {
        return null;
    }

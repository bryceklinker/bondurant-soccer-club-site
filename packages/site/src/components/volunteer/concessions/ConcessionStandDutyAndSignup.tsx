...
> = ({ signupLink, contactLink }) => {
    return (
        <>
            ...
            <Paragraph>
                The Concession Stand at the Bondurant Soccer Fields is staffed
                by volunteers and the profits are used to support the fields,
                players, and needs of the club. Parents that aren't coaching are
                expected to help out at the concession stand. If you have any
